export const mockTypes = [
  { id: '1', name: 'normal', pokemon: ['16', '17', '18', '19', '20'] },
  { id: '2', name: 'fighting', pokemon: ['56', '57', '66', '67', '68'] },
  { id: '3', name: 'flying', pokemon: ['21', '22', '144', '145', '146'] },
  { id: '4', name: 'poison', pokemon: ['1', '2', '3', '13', '14'] },
  { id: '5', name: 'ground', pokemon: ['27', '28', '31', '34', '50'] },
  { id: '6', name: 'rock', pokemon: ['74', '75', '76', '95', '111'] },
  { id: '7', name: 'bug', pokemon: ['10', '11', '12', '13', '14'] },
  { id: '8', name: 'ghost', pokemon: ['92', '93', '94', '200', '292'] },
  { id: '9', name: 'steel', pokemon: ['81', '82', '205', '208', '212'] }
];

export const mockPokieObj = {
  normal: [
    {
      name: 'pidgey',
      id: '16',
